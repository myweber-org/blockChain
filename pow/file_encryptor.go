...
func main() {
	if len(os.Args) < 5 {
		...
		fmt.Println("Example: go run file_encryptor.go encrypt input.txt encrypted.bin 6368616e676520746869732070617373776f726420746f206120736563726574")
		os.Exit(1)
	}
...
func main() {
	key := []byte("examplekey32byteslong123456789012")
